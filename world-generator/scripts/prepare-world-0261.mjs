...
const preparedInject=inject
  .replace("window.__WAFT_ADVENTURE_BUILD__='0.27.0-experimental'","window.__WAFT_ADVENTURE_BUILD__='0.27.2-experimental'")
...
if(oldBootstrap.test(s))s=s.replace(oldBootstrap,preparedInject);
  ...
  s=s.replace(marker,preparedInject+marker);
}
