...
def main():
    ...
    for item in [
        {'id':'gibraltar','name':'Gibraltar','type':'mountain-coast','center':{'lon':-5.35,'lat':36.14},'priority':99},
        {'id':'ceuta','name':'Ceuta','type':'coast-city','center':{'lon':-5.32042,'lat':35.88919},'priority':98},
        {'id':'melilla','name':'Melilla','type':'coast-city','center':{'lon':-2.93833,'lat':35.29369},'priority':98}
    ...
    for item in [
        ...
        {'id':'atlantic-canarias','name':'Corredor Atlántico · Canarias','position':{'lon':-7.2,'lat':36.0},'type':'air_sea','arrivalHeadingDegrees':210}
